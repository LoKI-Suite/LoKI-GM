function [rateCoeff, dependent] = multicomponentTransportChantry(~, densitiesAll, ~, reaction, rateCoeffParams, chemistry)
% multicomponentTransportChantry evaluates the transport rate coefficient of a particular neutral species interacting with the wall, 
%  taking into account both the multicomponent diffusion time (using Wilke's formula) and the wall reaction time,
