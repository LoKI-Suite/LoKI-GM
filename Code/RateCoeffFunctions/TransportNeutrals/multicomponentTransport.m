function [rateCoeff, dependent] = multicomponentTransport(~, densitiesAll, ~, reaction, rateCoeffParams, chemistry)
% multicomponentTransport evaluates the transport rate coefficient of a particular neutral species interacting with the wall, 
