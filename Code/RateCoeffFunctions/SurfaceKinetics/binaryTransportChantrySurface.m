function [rateCoeff, dependent] = binaryTransportChantrySurface(~, ~, totalGasDensity, reaction, rateCoeffParams, chemistry)
% binaryTransportChantrySurface evaluates the transport rate coefficient of a particular species interacting with the wall, 
