function [rateCoeff, dependent] = nitrogenAtomicVT(~, ~, ~, reaction, ~, chemistry)
% nitrogenAtomicVT evaluates the rate coefficient for V-T transitions between nitrogen molecules and atoms described in:
