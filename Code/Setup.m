    ...
    function selfDiagnostic(setup)
      ...
      if isfield(setupInfo, 'chemistry')
        ...
        elseif setupInfo.chemistry.isOn
          ...
          % --- 'convergenceParameter' field (controls the parameter to iterate in the quasineutrality cycle for steady-state simulations)
          if ~setup.pulsedSimulation
            ...
            elseif ~isfield(workCondStruct, 'dischargePowerDensity') && ...
              ...
              error([str1 'When the discharge power density cycle is activated, the parameter ' ...
                  '''dischargePowerDensity'' must be defined in the ''workingConditions''.' str2],1);
            elseif (~isfield(workCondStruct, 'chamberRadius') || workCondStruct.chamberRadius == 0) && ...
                  strcmp(setupInfo.chemistry.convergenceParameter, 'dischargeCurrent')
              error([str1 'When the discharge current cycle is activated, the chamber radius ' ...
                  '''workingConditions>chamberRadius''\n' ...
                  'must be defined as a positive number in the ''workingConditions''.' str2],1);
            elseif any(workCondStruct.excitationFrequency~=0) && ...              
                  strcmp(setupInfo.chemistry.convergenceParameter, 'dischargeCurrent')
              error([str1 'When the discharge current cycle is activated, the excitation frequency ' ...
