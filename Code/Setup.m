    ...
    function selfDiagnostic(setup)
      ...
      if isfield(setupInfo, 'chemistry')
        ...
        elseif setupInfo.chemistry.isOn
          ...
          % --- 'caseDefinition' field (controls the parameter to iterate in the quasineutrality cycle)
          if ~isfield(setupInfo.chemistry, 'caseDefinition')
            error([str1 '''caseDefinition'' field not found in the ' ...
                '''chemistry'' section of the setup file.' str2],1);
          elseif ~any(strcmp({'electronDensity' 'dischargeCurrent' 'dischargePowerDensity'}, setupInfo.chemistry.caseDefinition))
            error([str1 'Wrong value for the field ''chemistry>caseDefinition''.\n' ...
          ...
          elseif ~isfield(workCondStruct, 'dischargeCurrent') && ...
                strcmp(setupInfo.chemistry.caseDefinition, 'dischargeCurrent')
          ...
          elseif ~isfield(workCondStruct, 'dischargePowerDensity') && ...
                strcmp(setupInfo.chemistry.caseDefinition, 'dischargePowerDensity')
