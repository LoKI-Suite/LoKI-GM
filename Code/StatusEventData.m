...
classdef (ConstructOnLoad) StatusEventData < event.EventData
   ...
   methods
     ...
     function statusEventData = StatusEventData(message, type)
         statusEventData.message = message;
         statusEventData.type = type;
      end
